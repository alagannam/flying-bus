...
const APP_URL = process.env.NEXT_PUBLIC_APP_URL ?? 'https://app.theflyingbus.com'
  ...
  return (
    <header style={styles.header}>
      <div style={styles.inner}>
        <Link href={process.env.NEXT_PUBLIC_SITE_URL ?? 'https://theflyingbus.com'} style={styles.logo}>
